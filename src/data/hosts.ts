...
export const hosts: Host[] = [
  {
    id: "anoop-kurup",
    name: "Anoop Kurup",
    role: "Co-Host & Marketing Strategist",
    bio: "Anoop brings years of marketing expertise and business insights to the podcast. With a keen eye for digital trends and consumer behavior, he breaks down complex marketing strategies into actionable insights. His experience spans across various industries, making him adept at analyzing everything from startup growth hacks to enterprise brand strategies.",
    linkedin: "https://linkedin.com/in/anoopkurup",
    twitter: "https://twitter.com/anoopkurup",
...
export const podcastInfo = {
  ...
  rssUrl: "https://clickbrandandbeyond.com/feed.xml",
  email: "hello@clickbrandandbeyond.com",
  linkedin: "https://linkedin.com/company/click-brand-beyond"
}